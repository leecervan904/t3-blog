  ...
  const initMonaco = () => {
    ...
    if (containerElement.current) {
      ...
      if (model) {
        ...
        model = monaco.editor.createModel(finalValue, language, undefined);
        // console.log(language, finalValue, model.getLanguageId());
      }
      ...
      console.log(editor.current.getModel()?.getLanguageId());
